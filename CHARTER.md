...
AI education is most useful when it helps people improve real work without
separating technology from purpose, accountability, control, evidence, and
learning.

AI Dev Days exists to turn public research and operating practice into
practical education. It gives learners, practitioners, facilitators, and
contributors a place to investigate how people and AI can work together, test
...
Create open, practical research and education that helps people understand,
apply, verify, and improve AI participation in real work.

## Vision

People leave AI Dev Days able to make one useful part of work clearer, safer,
more reviewable, and easier to improve, regardless of which AI tool they use.

## Purpose

AI Dev Days provides:

- source-grounded research about AI participation in work;
- reusable curriculum and labs;
- event packets adapted to specific audiences and outcomes;
- tool-specific tracks that make abstract concepts concrete;
- public-safe examples and reviewable artifacts;
- facilitator, contributor, and maintainer guidance; and
- an evidence loop through which event experience can improve later research
  and education.
...
- business and personal workflows in which people and AI participate;
- operating standards, SOPs, shared context, evidence, and handoffs;
- agent tools, models, platforms, and implementation patterns as educational
  context;
- technical and nontechnical audiences;
- workshops, talks, labs, demonstrations, self-guided learning, and facilitator
  preparation; and
- research needed to keep those materials accurate and useful.
...
AI Dev Days does not:

- create a competing business operating framework;
- prescribe one tool, model, platform, or provider;
- certify attendees, organizations, tools, or framework conformance;
- replace legal, regulatory, safety, security, clinical, financial, or other
  professional guidance;
- promise that one event makes a workflow production-ready;
- publish private client or attendee data;
- turn Digital Meld commercial methods into framework requirements;
- treat attendance, content volume, or demo polish as proof of learning; or
- claim that educational material is current without a stated review basis.

## Stewardship

Brad Groux is the creator and founding steward of AI Dev Days. Until governance
...
- determines when broader community governance is warranted.

Stewardship does not create professional authority over every domain
represented in an event or example.

## Community Promise

AI Dev Days will:

- remain publicly inspectable;
- preserve attribution and contribution history;
- provide a clear contribution and correction path;
- identify approved, draft, historical, and superseded material honestly;
- keep framework citations close to framework claims;
- record material program decisions rather than changing direction silently;
- publish known limitations with releases; and
- keep essential public educational material available without requiring a
  commercial relationship.

## Amendment

A material charter amendment requires:
...
6. an identifiable effective version and date.

No research note, event packet, tool track, example, or marketing message may
amend this charter implicitly.

## Motto

> **Research the work. Teach the method. Preserve the evidence.**

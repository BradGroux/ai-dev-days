...
tree, with the exact release commit recorded in the GitHub release. The
[coordinated Commons refresh review](../reviews/open-framework-commons-v1.0.0-coordinated-refresh-review-2026-08-03.md)
records the sanitized candidate findings and validation limits.

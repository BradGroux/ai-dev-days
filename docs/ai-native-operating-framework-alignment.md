...
3. [SOP content standard](https://github.com/BradGroux/ai-native-operating-framework/blob/v1.0.0/framework/sop-content-standard.md)
4. [Shared operating memory standard](https://github.com/BradGroux/ai-native-operating-framework/blob/v1.0.0/framework/shared-operating-memory-standard.md)
...
| Tool tracks | Supply current implementation instructions and exercises | Tool-specific; not framework requirements |
...
| --- | --- |
| Intent | Purpose, audience, scope, expected outcome, and governing requirements |
| Responsibility | Accountable owner, facilitators, participants, approvals, and escalation |
| Work | Prerequisites, agenda, activities, decisions, handoffs, and outputs |
| Control | Safety, privacy, permissions, boundaries, exceptions, stop conditions, and recovery |
...
2. **Document:** prepare the event packet, requirements, agenda, runbook,
   controls, evidence expectations, and recovery path.
3. **Validate:** walk through normal participation, meaningful exceptions, and
   credible failure or recovery scenarios.
4. **Approve:** identify the accountable event owner, approved packet, event
   date, and any accepted limitations.
5. **Use:** run the event from the approved packet and preserve required
   evidence, state, decisions, and handoffs.
...
- current event status and unresolved questions;
- verification evidence and authoritative outputs;
- exceptions, incidents, recovery actions, and limitations;
- handoff state, owners, and next actions; and
- lessons accepted for future curriculum or event-template changes.

Storage does not make a note authoritative. Mark drafts, assumptions,
uncertainty, approvals, freshness, and superseded material clearly.

Publication safety, access, privacy, rights, retention, correction, and
recovery apply to operating memory. Do not preserve secrets, credentials,
private attendee data, or sensitive operational material in this public
repository.
...
- prerequisites, activities, decisions, outputs, and handoffs are usable;
- permissions, safety boundaries, exceptions, stop conditions, and recovery
  are visible;
- completion and verification produce reviewable evidence;
- sources and material claims are traceable; and
- the post-event review has an owner and a durable location.

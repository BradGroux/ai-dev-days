...
- Point to the public [grill-with-docs prompt](https://github.com/BradGroux/ai-dev-days/blob/master/event-specific/2026-07-21-personal-ai-agents-live/prompt-pack.md#2-openclaw-grill-with-docs) if Andrea asks how to reuse the pattern.
...
- Point to the AI Dev Days repository and the SSTB.ai Discord QR code.

...
Use this from the root of `BradGroux/ai-dev-days`.
...
2. If the event packet source docs under `event-specific/2026-07-21-personal-ai-agents-live/` are not already on `origin/master`, create and merge a small bootstrap PR that adds only the already-authored event packet docs needed by the issues. Do not include app implementation in that bootstrap PR.
...
- `event-specific/2026-07-21-personal-ai-agents-live/demo/implementation-plan.md`
...
- `event-specific/2026-07-21-personal-ai-agents-live/demo/presentation-prompt.md`
- `event-specific/2026-07-21-personal-ai-agents-live/demo/source-corpus/`

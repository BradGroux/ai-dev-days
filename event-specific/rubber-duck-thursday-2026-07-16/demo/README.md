...
Do not use real invoices, bank details, personal data, customer records, lab results, shipment credentials, or private business information. Do not connect live systems or allow the demo to send, pay, schedule, release, approve, or modify external records.

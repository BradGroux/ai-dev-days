...
Use this on Sunday, May 31, 2026.
...
- [ ] Set Do Not Disturb.
- [ ] Keep [`fallback-plan.md`](fallback-plan.md) open.

## Content Safety

- [ ] Do not show private DMs, credentials, customer data, sponsor terms, or unreleased announcements.
- [ ] Do not let the demo send or publish anything.
- [ ] Keep all outputs draft-only.
- [ ] Verify the Discord QR scans to https://discord.gg/Gmfkm7QVSF.

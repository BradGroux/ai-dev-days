...
This short demo does not require attendees to install OpenClaw. It only requires the presenter machine to be ready.
...
Use public-safe examples only. Keep every generated artifact draft-only until reviewed by a human.
